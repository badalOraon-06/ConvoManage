...
const EditSession = () => {
  ...
  const fetchSession = async () => {
    try {
      ...
      if (user.role !== 'admin' && session.speaker._id !== user.id) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Update session information</p>
        </div>
      </div>
